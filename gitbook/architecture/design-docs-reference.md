# Design Docs Reference / 设计文档索引

本页索引仓库内与核心框架相关的深度设计文档，便于与 GitBook 配套阅读。这些文档位于 `docs/architecture/`，与当前开源的执行逻辑一致。
...
| [execution-flow-and-generality.md](../../docs/architecture/execution-flow-and-generality.md) | 执行流程详解与通用性分析：三条触发路径、场景级追踪、通用性结论 |
...
阅读顺序建议：先读 GitBook 的 [Architecture Overview](overview.md) 与 [Open Source Scope](open-source-scope.md)，再按需查阅上表文档。
